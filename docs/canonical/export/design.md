...
*導出元: SPEC-092, SPEC-093, SPEC-094, SPEC-095, SPEC-096, SPEC-097, SPEC-098, SPEC-099, SPEC-100, SPEC-101, SPEC-102, SPEC-103, SPEC-104, SPEC-105, SPEC-319*
...
### DES-S052 5.5 `rust-cargo` SourceDiscoveryAdapter
...
## DES-S053 6. Target Reference解決

### DES-S054 6.1 adapter-neutral解決contract
...
### DES-S055 6.2 `rust-cargo` locator解決
...
## DES-S057 7. Static Analysis orchestrationと`rust-cargo`ルール
...
### DES-S059 7.3 target 到達の静的証明と runtime 証明の関係（target_binding）
...
### DES-S066 9.2 `rust-cargo` TestRunnerAdapter
...
### DES-S067 9.3 `rust-cargo` 結果のパース
...
## DES-S069 10. `rust-cargo` Target Binding 動的計測
...
## DES-S076 16. 並列動作と整合性

### DES-S077 16.1 ロック不要の根拠
...
## DES-S081 12. CLI 詳細仕様

### DES-S082 12.1 共通仕様

*導出元: REQ-S009, SPEC-S012, SPEC-S013, SPEC-S055, SPEC-S078, SPEC-S096, SPEC-S106, DS-S013, DS-S014, DS-S018, DS-S055, DS-S079, DS-S085, DS-S117, DS-S127, BD-S049, BD-S052, BD-S071*
...
## DES-S085 14. Form Schema 設計

### DES-S086 14.2 検証器

*導出元: SPEC-S041, SPEC-S078, SPEC-S083, DS-S042, DS-S085, DS-S090, DS-S092, BD-S020, BD-S052, BD-S057*
...
## DES-S088 15. Structured Test Operation adapter contract

### DES-S089 15.1 `rust-cargo` 対象の特定
...
### DES-S090 15.2 `rust-cargo` 編集・挿入の適用
...
### DES-S091 15.3 `rust-cargo` annotation blockの再生成
...
### DES-S092 15.4 `rust-cargo` 1 Test境界の保証
...
### DES-S095 18.3 機能別受入条件

#### DES-S096 18.3.1 discovery・record・graph と chain_integrity

*導出元: SPEC-S009, SPEC-S018, SPEC-S028, SPEC-S043, SPEC-S077, SPEC-S083, SPEC-S095, DS-S010, DS-S020, DS-S032, DS-S044, DS-S056, DS-S083, DS-S090, DS-S115, BD-S017, BD-S021, BD-S051, BD-S057*
...
#### DES-S097 18.3.3 決定論的静的解析（oracle_presence・target_binding 静的到達）

*導出元: SPEC-S021, SPEC-S025, SPEC-S085, SPEC-S086, DS-S023, DS-S024, DS-S029, DS-S094, DS-S095, DS-S097, BD-S012, BD-S015, BD-S059, BD-S060*

### DES-552

正常Testは違反なしとなり、各違反fixtureは対応ruleで非PASSになる。

#### DES-S098 18.3.4 execution・Evidence（target_binding の証拠）

*導出元: SPEC-S051, SPEC-S076, DS-S025, DS-S050, DS-S051, DS-S077, DS-S104, DS-S116, BD-S013, BD-S047, BD-S064*

### DES-553

Evidence writerは中立fieldの`hashes.test_subject`と`hashes.targets[].target_construct`を出力する。

#### DES-S099 18.3.5 target_binding 動的計測（per-target）

*導出元: SPEC-S020, SPEC-S051, SPEC-S086, DS-S022, DS-S050, DS-S097, DS-S111, BD-S069*
...
#### DES-S101 18.3.8 verify・report と scope

*導出元: SPEC-S017, SPEC-S053, SPEC-S054, SPEC-S055, SPEC-S069, SPEC-S094, SPEC-S096, DS-S018, DS-S019, DS-S053, DS-S054, DS-S055, DS-S069, DS-S114, DS-S117, BD-S010, BD-S039, BD-S071*
...
#### DES-S102 18.3.9 フェーズゲート評価

*導出元: REQ-S057, SPEC-S012, SPEC-S016, SPEC-S050, SPEC-S069, SPEC-S098, SPEC-S105, SPEC-S106, DS-S013, DS-S017, DS-S049, DS-S069, DS-S119, DS-S126, DS-S127, BD-S039, BD-S072*
...
#### DES-S103 18.3.10 Structured Test Operation / Create の挿入後検証とロールバック
...
#### DES-S104 18.3.12 adapter contract

*導出元: SPEC-S063, SPEC-S078, SPEC-S105, DS-S007, DS-S063, DS-S085, DS-S126, BD-S029, BD-S052*
