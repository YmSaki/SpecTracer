...
use syn::{
    Expr, ExprCall, ExprClosure, ExprMethodCall, File, Item, ItemFn, ItemUse, Macro, Pat,
    ReturnType, Stmt, Type, UseTree,
};

use crate::{
    has_attribute, source_location_from_item, source_location_from_span, AuditVerdict, RuleResult,
};
